...
weight: 20
upstream_link: https://github.com/minio/docs/blob/35f2bb81280a3573c64947e8bd979e2c7026d2dd/source/integrations/disaggregated-spark-and-hadoop-hive-with-minio.md
...
### **3.1 Configure Hadoop** {#configure-hadoop}
...
### **3.2 Configure Spark2** {#configure-spark2}
...
### **3.3 Configure Hive** {#configure-hive}
...
## **4. Run Sample Applications** {#run-sample-applications}
