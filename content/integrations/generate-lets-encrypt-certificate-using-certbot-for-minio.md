...
### Step 3: Verify Certificates {#step-3-verify-certificates}
...
### Step 4: Set up SSL on MinIO Server with the certificates. {#step-4-set-up-ssl-on-minio-server-with-the-certificates}
...
### Step 5: Change ownership of certificates. {#step-5-change-ownership-of-certificates}
...
### Step 6: Start MinIO Server using HTTPS. {#step-6-start-minio-server-using-https}
...
```sh
$ sudo docker run -p 443:443 -v /home/user/.minio:/root/.minio/ -v /home/user/data:/data pgsty/silo:RELEASE.2026-09-03T13-18-01Z server --address ":443" /data

```

### Step 7: Visit [https://myminio.com](https://myminio.com) in the browser. {#step-7-visit-https-myminio-com-in-the-browser}
