...
本文档假定已安装 Docker、Podman 或其他支持标准容器镜像格式的类似 runtime。已发布的 `docker.io/pgsty/silo` 发行镜像使用 [Red Hat Universal Base Image 9 Micro](https://catalog.redhat.com/software/container-stacks/detail/609560d9e2b160d361d24f98)。
...
>
> 示例固定到已发布 Server 标签。生产部署仍需验证该版本与实际负载，并记录镜像摘要以便回滚。
>
