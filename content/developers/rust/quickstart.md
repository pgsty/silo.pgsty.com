---
title: "MinIO Rust SDK for Amazon S3 Compatible Cloud Storage"
url: "/developers/rust/quickstart/"
weight: 9064
toc_hide: true
minio_origin: true
silo_modified: false
...
<a id="minio-rust-sdk-for-amazon-s3-compatible-cloud-storage"></a>
...
All request builders implement the \[`S3Api`\] trait, which provides the async [`send`](https://docs.rs/minio/latest/minio/) method to execute the request and return a typed response.
...
- [Upload a file to MinIO](#file-uploader-rs)
- [Upload a file to MinIO with CLI](#file-uploader-rs)

### file_downloader.rs {#file-downloader-rs}

- [Download a file from MinIO](#file-downloader-rs)

### object_prompt.rs {#object-prompt-rs}

- [Prompt a file on MinIO](#object-prompt-rs)
