...
url: "/reference/minio-mc/mc-idp-ldap-disable/"
weight: 20
minio_origin: true
silo_modified: false
---
...
The [`mc idp ldap disable`](#command-mc.idp.ldap.disable) command disables the currently configured AD/LDAP provider.
...
The [alias](/reference/minio-mc/mc-alias-set/#alias) of the MinIO deployment for which to disable the AD/LDAP integration.
