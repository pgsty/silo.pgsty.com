...
当前版本为 [mcli 20260916](/zh/blog/release/mcli-20260916/)，使用 Go 1.27.1、pkg v3.14.1 与上游 SDK `32e1f32cb176`。完整行为变化见[兼容性注记](/zh/compatibility/mcli/#current-release)，Server/Console 版本边界见[组件矩阵](/zh/compatibility/versions/)。
