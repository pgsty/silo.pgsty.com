...
上述表格记录本地测试和隔离进程观察。主干集成另有远端证据：[PR #180](https://github.com/pgsty/silo/pull/180) 的 9 项检查全部通过，包括 [Go CI](https://github.com/pgsty/silo/actions/runs/34687012173) 的六项任务、[DCO](https://github.com/pgsty/silo/actions/runs/34687012139)、[漏洞检查](https://github.com/pgsty/silo/actions/runs/34687012148)和[发布流程验证](https://github.com/pgsty/silo/actions/runs/34687012164)。合并后已核对主干树与通过检查的 PR 合并树完全一致。这些证据不等同于真实 Linux 多节点集群、正式发布制品或生产部署验证。
