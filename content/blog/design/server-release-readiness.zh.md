...
**9 月 16 日源码进展：** #10 已由独立的单对象条件删除 #145 关闭，批量 ETag 删除仍未实现；#77 及 #99/#100 已在 main 修复。#133/#144 后续由 #178 处理，#79 默认列表限制仍开放。它们均不能倒写为 20260903 的保证。见[当前组件与源码矩阵](/zh/compatibility/versions/)。
