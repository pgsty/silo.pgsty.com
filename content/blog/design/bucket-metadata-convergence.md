...
The table above records local tests and isolated-process observations. Remote integration evidence is separate: all nine checks on [PR #180](https://github.com/pgsty/silo/pull/180) passed, comprising six [Go CI](https://github.com/pgsty/silo/actions/runs/34687012173) jobs, [DCO](https://github.com/pgsty/silo/actions/runs/34687012139), [vulnerability analysis](https://github.com/pgsty/silo/actions/runs/34687012148), and [release-pipeline validation](https://github.com/pgsty/silo/actions/runs/34687012164). The merged main tree was verified to match the PR merge tree that passed these checks. This is not proof of real Linux multi-node cluster behavior, official release artifacts, or production deployment.
