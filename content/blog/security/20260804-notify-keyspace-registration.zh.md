...
**后续状态：** 本文当时留下的 Postgres/MySQL 离散连接字段迁移问题已由 `f1ba68358` 修复并随 Server 20260903 发布；启用目标缺少规范 DSN 时明确阻止启动。详见[数据库通知迁移](/zh/blog/design/notify-url/)。这不表示其它 tokenizer 观察也已经解决。
