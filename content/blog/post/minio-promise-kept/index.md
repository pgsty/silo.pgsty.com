...
Two months ago in ["MinIO is Dead, Long Live MinIO,"](/blog/post/minio-resurrect/) I promised I'd keep the MinIO fork patched. 
...
Full write-ups, CVSS arithmetic, and PoCs are in the [release notes](/blog/release/20260417/). The short version:
...
- [**MinIO Is Dead, Long Live MinIO**](/blog/post/minio-resurrect/)
- [**From AGPL to Apache: Reflections on Pigsty's License Change**](https://vonng.com/en/pg/pigsty-relicense/)
- [**Originally published in Chinese**](/zh/blog/post/minio-promise-kept/)
