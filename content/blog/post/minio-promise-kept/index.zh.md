...
aliases:
  - /blog/minio-promise-kept/
  - /blog/db/minio-promise-kept/
---

两个月前，我在《[MinIO 已死，MinIO 复生](/zh/blog/post/minio-resurrect/)》里立了一个 flag，承接上游的烂摊子，跟 CVE、修 Bug。
...
这篇文章我不想写成漏洞分析报告。具体每一条的 CVSS 分数、攻击链、PoC 代码，我在 [发布注记](/zh/blog/release/20260417/) 里都一一列了，感兴趣的朋友可以去看。这里只说一句话版本：
