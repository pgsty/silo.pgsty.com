...
> **Later release, 2026-09-17:** [Server 20260916](/blog/release/silo-20260916/) is available with signed-request, IAM, multi-pool, replication and embedded Console repairs, plus coordinated-upgrade requirements. This article retains the component and validation scope of 20260903.


> **Status on 2026-09-13:** this remains the latest published Server; its dependencies have not changed. Later security, storage and dependency fixes are on main, including the unreleased [SN-2026-011 fix](/blog/security/20260913-signed-header-status/). New standalone mcli/pkg releases do not replace this artifact’s contents; see the [component matrix](/compatibility/versions/).
