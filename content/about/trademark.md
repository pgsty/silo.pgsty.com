...
linkTitle: "Trademark"
description: "MinIO is a trademark of MinIO, Inc. Silo is an independently maintained community fork, with no affiliation."
url: "/about/trademark/"
weight: 20
type: docs
...
## Why the name still appears in this documentation {#why}

A license grants rights in copyright; it says nothing about names. [AGPLv3](/about/license/) gives anyone the right to fork and redistribute the MinIO codebase, but trademark law is a separate matter that a license does not settle.
...
- [Attribution](/about/attribution/) — copyright stack and derivation of this documentation
