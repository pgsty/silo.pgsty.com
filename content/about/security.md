...
- **This documentation** — open an issue on [`pgsty/silo-docs`](https://github.com/pgsty/silo-docs/issues); if the content itself discloses a weakness, use a private channel instead.
